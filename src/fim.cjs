...
const SHACL_SHAPES_FILE_IN_SERVER_PUBLIC_DIR = "../public/data-fields-shacl-shapes.js";
...
fim:${fimId} a sh:NodeShape ;
    sh:property [`;
        ...
        let stringified = JSON.stringify(shaclShapesMap, null, 2);
        fs.writeFile(SHACL_SHAPES_FILE, stringified, "utf8", () => {});
        stringified = `// This file is auto-generated by fim.js and committed for convenience.
const dataFieldsShaclShapes = ${stringified};
`;
        fs.writeFile(SHACL_SHAPES_FILE_IN_SERVER_PUBLIC_DIR, stringified, "utf8", () => {});
    });
}
